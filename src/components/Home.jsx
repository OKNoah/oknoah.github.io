    ...
    return (
      <div>
        ...
        <div className={classes.content}>
          <p>The Screen Production Yukon Association (SPYA), formerly known as the Northern Film and Video Industry Association (NFVIA), represents the screen-based media production industry and its workers in Yukon
          ...
          <p>If you are looking for more information on membership, grip and electrics equipment rental, crew members, productions services, please contact us. We will be delighted to assist you in any way that we can.</p></p>
        </div>
      </div>
    );
  }
